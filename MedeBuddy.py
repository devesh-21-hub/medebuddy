...
class Login_Window:
    ...
    def login(self):
        ...
        elif self.txtuser.get()=="devesh"and self.txtpass.get()=="kumar":
            messagebox.showinfo("Success","Welcome")
            self.new_window=Toplevel(self.root)
            self.app=Hospital(self.new_window)
        else:
            conn=mysql.connector.connect(host="localhost",user="root",password="deveshkumar21",database="hospital")
...
class Hospital():
    def __init__(self,root):
        ...
        lbltitle=Label(self.root,bd=20,relief=RIDGE,text="+ MedeBuddy",fg="red",bg="white",font=("times new roman",50,BOLD))
        ...
        #========================Buttons===========================================
        img=Image.open(r"C:\Users\deves\Images\Downloads\Prescription.jpeg")
        ...
        img=Image.open(r"C:\Users\deves\Images\Downloads\Prescriptiondata.jpeg")
        ...
        img=Image.open(r"C:\Users\deves\Images\Downloads\Update.jpeg")
        ...
        img=Image.open(r"C:\Users\deves\Images\Downloads\Delete.jpeg")
        ...
        img=Image.open(r"C:\Users\deves\Images\Downloads\Reset.jpeg")
    ...
    def iPrescriptiondata(self):
        if (self.Nameoftablets.get()==""or self.ref.get()==""):
            ...
            conn=mysql.connector.connect(host="localhost",username="root",password="deveshkumar21!",database="hospital")
            my_cursor=conn.cursor()
    ...
    def iexit(self):
        iexit=messagebox.askyesno("MedeBuddy","Confirm you want to exit")
        if iexit>0:
